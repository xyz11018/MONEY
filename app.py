            ...
            with open(DB_FILE, "r", encoding="utf-8") as f: 
                ...
                if "tw_portfolio" in data or "us_portfolio" in data:
                    ...
                    if "tw_portfolio" in data and data["tw_portfolio"]:
                        new_data["schemes"]["🎯 台股主力配置"] = {"market": "TW", "assets": data["tw_portfolio"]}
                    if "us_portfolio" in data and data["us_portfolio"]:
                        new_data["schemes"]["🎯 美股主力配置"] = {"market": "US", "assets": data["us_portfolio"]}
                    return new_data
        except: pass
    return default_data
...
<div style='padding:12px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:6px; margin-bottom:12px;'>
    <div style='color:#64748b; font-size:0.8rem; font-weight:700; margin-bottom:4px;'>💱 即時匯率 (USD/TWD)</div>
    <div style='color:#0f172a; font-size:1.3rem; font-weight:900;'>{current_rate:.2f}</div>
</div>
""", unsafe_allow_html=True)
